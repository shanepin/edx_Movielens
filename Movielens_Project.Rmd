...
explored to further improve the accuracy of the model like year of release, star cast etc. More advanced models featuring Random Forests and those based on
...
computationally intensive. It is likely that future iterations of models involving K-Nearest-Neighbors and Collaborative Filtering with cosine similarity
